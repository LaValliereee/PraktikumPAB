                    ...
                    child: SafeArea(
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            'Data profil dari halaman register',
                            style: TextStyle(
                              fontSize: 14,
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildProfileMenuItem(
                          icon: Icons.badge,
                          title: 'NBI',
                          subtitle: profile.nbi,
                        ),
                        const SizedBox(height: 12),
                        _buildProfileMenuItem(
                          icon: Icons.email,
                          title: 'Email',
                          subtitle: _fallbackText(profile.email),
                        ),
                        const SizedBox(height: 12),
                        _buildProfileMenuItem(
                          icon: Icons.location_on,
                          title: 'Alamat',
                          subtitle: _fallbackText(profile.alamat),
                        ),
                        const SizedBox(height: 12),
                        _buildProfileMenuItem(
                          icon: Icons.camera_alt,
                          title: 'Instagram',
                          subtitle: _fallbackText(profile.instagram),
                        ),
                        const SizedBox(height: 32),
                        Container(
                          decoration: BoxDecoration(
    ...
    return Container(
      ...
      child: Row(
        children: [
          Container(
            decoration: BoxDecoration(
              color: const Color(0xFF7ED5A0).withValues(alpha: 0.1),
